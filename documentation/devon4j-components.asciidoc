...
Navigate to `/jtqj-core/source/main/resources/db/applications.properties` and add ', classpath:db/h2':

image::images/devon4j/4.Components/applicationproperties.png[ApplicationProperties, 300]
