...
image::images/devon4j/4.Components/select_getter_setter.png[Select Getter Setter, 500]
...
If you happen to see the above error while running the Health Chek you will have to import the CobiGen Templates locally:
